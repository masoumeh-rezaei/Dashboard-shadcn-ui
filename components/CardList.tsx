                ...
                {title === 'Popular Products' ? popularProducts.map((item) => (
                    <Card key={item.id} className="flex-row items-center justify-between gap-4 p-4">
                        ...
                        <CardContent className="flex-1 p-0">
                            <CardTitle className="text-sm font-medium whitespace-nowrap">{item.name}</CardTitle>
                    ...
                    <Card key={item.id} className="flex-row items-center justify-between gap-4 p-4">
                        ...
                        <CardContent className="flex-1 p-0">
                            <CardTitle className="text-sm font-medium whitespace-nowrap">{item.title}</CardTitle>
